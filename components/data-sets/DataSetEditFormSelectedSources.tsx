import type { DataSetType, PreaggregationConfig } from '@/types/data-set';
import type { DataSource } from '@/types/data-source';

interface DataSetEditFormSelectedSourcesProps {
...
export default function DataSetEditFormSelectedSources({
  selectedDataSources,
  dataSetType,
  preaggregationConfig,
  onRemoveDataSource,
  onPreaggregationConfigChange,
}: DataSetEditFormSelectedSourcesProps) {
                ...
                <div className="mt-3 pt-3 border-t border-[var(--color-border)] flex gap-3">
                  <div className="flex-1">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        onPreaggregationConfigChange(dataSource.id, {
